...
For crashes, UI glitches, or other technical problems:
...
<div class="beta-docs__callout beta-docs__callout--info">
  <strong>Keep conversations confidential</strong>
  Do not share screenshots, recordings, or details of conversations outside Dialog Lab without permission. Your partners expect a respectful space to explore difficult topics.
</div>

## Response expectations

Dialog Lab is a small team. We review reports as soon as possible, but response times may vary. Reports involving harassment or severe incivility are prioritized.

For step-by-step help using the app, start at [Quick Start](/support/) or browse the guides in the sidebar.
